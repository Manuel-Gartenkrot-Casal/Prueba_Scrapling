...
def get_coleccion(nombre: str):
    """Devuelve una colección por nombre. Lo usan el runner genérico y el
    generador a partir del campo 'coleccion' de cada fuente en fuentes.json."""
    return db[nombre]
